...
const Navbar = () => {
  ...
  return (
    <div className="container navbar mb-2 shadow-lg bg-primary text-neutral-content mx-auto rounded-box">
      ...
      <div className="flex-1 px-2 mx-2">
        <div className="flex items-center flex-wrap lg:flex-no-wrap">
          ...
          <div className="dropdown">
            ...
            <ul className="p-2 shadow menu dropdown-content bg-base-100 rounded-box w-52 text-accent">
              <li>
